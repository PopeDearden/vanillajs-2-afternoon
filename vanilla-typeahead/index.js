const characters = [
    ...
    }, 
    {
        ...
        "url": "https://www.swapi.co/api/people/4/"
    }, 
    {
        "name": "Leia Organa", 
        "height": "150", 
        ...
        "birth_year": "19BBY", 
        "gender": "female", 
        "homeworld": "https://www.swapi.co/api/planets/2/", 
        "films": [
            "https://www.swapi.co/api/films/2/", 
            "https://www.swapi.co/api/films/6/", 
            "https://www.swapi.co/api/films/3/", 
        ...
        "url": "https://www.swapi.co/api/people/5/"
    }, 
    {
        "name": "Owen Lars", 
        "height": "178", 
        ...
        "url": "https://www.swapi.co/api/people/6/"
    }, 
    {
        ...
        "url": "https://www.swapi.co/api/people/7/"
    }, 
    {
        "name": "R5-D4", 
        "height": "97", 
        ...
        "url": "https://www.swapi.co/api/people/8/"
    }, 
    {
        ...
        "url": "https://www.swapi.co/api/people/9/"
    }, 
    {
        "name": "Obi-Wan Kenobi", 
        "height": "182", 
        ...
        "birth_year": "57BBY", 
        "gender": "male", 
        "homeworld": "https://www.swapi.co/api/planets/20/", 
        "films": [
            "https://www.swapi.co/api/films/2/", 
            "https://www.swapi.co/api/films/5/", 
            "https://www.swapi.co/api/films/4/", 
        ...
        "vehicles": [
            "https://www.swapi.co/api/vehicles/38/"
        ], 
        "starships": [
        ...
        "url": "https://www.swapi.co/api/people/10/"
    }
]
const list = document.getElementById('list');
const search = document.querySelector('input');

// fetch('https://www.swapi.co/api/people/', { mode: 'no-cors' })
// .then(response => response.json())
// .then(response => characters.push(...response.results)).catch(error => console.log(error))
